			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<form class="form-horizontal" role="form" action="editmodified" method="post">
						<!--------detail start------------>
                        <div class="portlet box red">
							...
							<div class="portlet-body flip-scroll">
								...
								<tbody>
								  <c:forEach items="${provalue}" var="mer">
								<tr>
									<td>
										Product Code:*
										<input type="hidden" name="hiddenproid" id="hiddenproid" value="${mer.id}">
									</td>
									<td>
									
									<input type="text" class="form-control" id="productcode" placeholder="" name="productcode" value="${mer.productcode}">
									</td>
								</tr>
								<tr>
									<td>
									...
									<td >
									  <input type="text" class="form-control" id="procategory" placeholder="" name="procategory" value="${mer.procategory}">
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" class="form-control" id="prodes" placeholder="" name="prodes" value="${mer.productdesc}">
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" class="form-control" id="expperiod" placeholder="" name="expperiod" value="${mer.expiryperiod}">In Months
									</td>
								</tr>
