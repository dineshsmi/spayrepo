					...
					<div class="col-md-12">
						...
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <a href="<%=request.getContextPath()%>/productfrom"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:120px;">Product Enroll</button></a>
                             
                              <a href="<%=request.getContextPath()%>/feessetting"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:120px;">Fee Settings</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" action="saveproductform" method="post">
									<div class="form-body" style="text-align: left;padding-left:160px;">
										...
										<div class="form-group" >
											...
											<div class="col-md-10" id="test">
												<input type="text" class="form-control" id="productcode" placeholder="" name="productcode" style="width:400px;">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="procategory" placeholder="" name="procategory" style="width:400px;">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">Product Description:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" id="prodes" placeholder="" name="prodes" style="width:400px;">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">Expiry Period:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" id="expperiod" placeholder="" name="expperiod" style="width:400px;">
												In Months
									...
									<div class="form-actions right1" style="text-align: left;padding-left:315px;">
										<button type="submit" class="btn redclr" id="id_sbtbtn" onclick="return validFun()" style="border-radius: 25px !important;width:80px;">Save</button>
...
function validFun(){
	...
	if(procode == ""){
		alert("Product code is not empty");
