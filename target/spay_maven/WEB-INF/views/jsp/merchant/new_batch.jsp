								...
								<form class="form-horizontal" role="form">
									<div class="form-body">
										...
										<div class="form-group">
											<label for="exampleInputFile" class="col-md-3 control-label">Select batch file:</label>
											<div class="col-md-9">
												<input style=" margin-top:6px;" type="file" id="exampleInputFile">
											</div>
										</div>
                                        
                                        <div class="form-group">
											<label class="col-md-3 control-label">Review transaction:</label>
											<div class="col-md-9">
							...
							<div class="portlet-body">
								<div class="table-scrollable">
                                    ...
                                    <tr>
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Total transaction:</label>
											<div class="col-md-9">
									...
									<div class="form-actions">
										<div class="row">
											<div class="col-md-offset-3 col-md-9">
												<button type="button" class="btn green">Process</button>
											</div>
										</div>
									</div>
								</form>
