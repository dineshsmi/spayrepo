					...
					<div class="col-md-12">
                        ...
                        <div class="portlet box blue-chambray">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" name="selectform" action="merchantprofile">
									<div class="form-body">
										<div class="row">
											<div class="col-xs-5">Merchant update successfully</div>
										</div>
									</div>
									
									 <div class="form-actions right1">
										
										<button type="submit" class="btn green" id="id_sbtbtn">Back</button>
									</div>
								</form>
							</div>
						</div>
