...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner container-fluid">
		...
		<div class="page-logo">
			...
			<a href="index.html">
			<img src="../assets/admin/layout2/img/bcel-logo-rev.png" class="img-responsive" />
			</a>
		...
		<div class="page-sidebar-wrapper">
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<li class="last ">
					...
					<ul class="sub-menu">
						<li>
							<a href="maps_google.html"><i class="fa fa-chevron-right"></i>
							01</a>
						</li>
						<li>
							<a href="maps_vector.html"><i class="fa fa-chevron-right"></i>
							02</a>
						</li>
					</ul>
				</li>
...
function backFun(){
	document.searchform.action="<%=request.getContextPath()%>/merchantrealtimetxn";
	document.searchform.submit();
}

function viewRealTranaction(val){
	
	window.open("<%=request.getContextPath()%>/realtranactionpopup?tid="+val,"_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=200, left=500, width=1000, height=1000")
}
