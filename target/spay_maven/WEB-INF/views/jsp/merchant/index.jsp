		...
		<div class="page-sidebar-wrapper">
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<li>
					<a href="javascript:;">
					<i class="fa fa-credit-card"></i>
					<span class="title">B-Invoice</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
			...
			<div class="page-content">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						Welcome Valuable Merchant<br><br>

						Welcome to the Merchant Control Center - your complete resource for payment management. We offers value added services for the user to avail all essential payment services inorder to cover your business Needs.
						<br><br>
						For any Enquires?<br>
						Please contact the Business Administration Team for assistance. You can write an email to the helpline @ techsupport@bcel.com.la 
