...
<script>
 ...
 $(function() {//merchant_merchantDOB
	 $("#id_reportdate" ).datepicker({changeMonth: true,changeYear:true,yearRange: "1900:3000"});
...
$(document).ready(function(){
	 ...
	 $("#id_reconfileresult").hide();
	 
	 var reportdtVal =  $("#id_reconfileDateVal").val();
	 
	 //alert("reportdtVal==>"+reportdtVal);
	 
	 if(reportdtVal.length>0){
		 
		 alert("In not null");
		 
		 $("#id_reconfilediv").hide();
		 $("#id_reconfileresult").show();
		
	 }
	 
	 $("#btn1").click(function(event){
		 
		 var merchantid =  $("#id_reportdate").val();
		 ...
		 if(merchantid == ""){
			...
			document.frmReconfileform.submit();
		 }
	});
					...
					<div class="col-md-12">
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <a href="<%=request.getContextPath()%>/reconfile"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:123px;">Daily Recon File</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form name="frmReconfileform" class="form-horizontal" role="form" action="showReconfileresult" method="post">
								
								   <input type="hidden" id="id_reconfileDateVal" name="reconfileDate" value="${repordateVal}">
								
								   
								    <input type="hidden" id="id_reconfileDateValreplcae" name="replaceddtval" value=" ${fn:replace(repordateVal,'/','')}">                                                                       
								
									 <div class="form-body" id="Container">
									 
									 <div id="id_reconfilediv">
									   <div class="form-group">
											<label class="col-md-2 control-label">Report Date:</label>
											<div class="col-md-10">
												<input type="text" class="" id="id_reportdate" placeholder="" name="reportdate" maxlength ="10">
									    ...
									    <table border="1">
									           ...
									           <tr>
									                ...
									                <td colspan=3 align="right"> 
									                  ...
									                  <a href="<%=request.getContextPath()%>/downloadAlltransactions/${fn:replace(repordateVal,'/','')}">Download All</a>
									             ...
									             <tr> 
									                 <td align="right"><b>Recon Date</b></td>
									                 
									                 <td align="center"><b>Recon File Name</b></td>
									                 
									                 <td align="center"><b>Report Format</b></td>
									             </tr>
									             <tr>
									                 <td align="right"> 
									                      ${repordateVal}
									                 ...
									                 <td align="center"> 
									                      <a href="<%=request.getContextPath()%>/bcelatmandunionpay/${fn:replace(repordateVal,'/','')}">BCEL ATM and Unionpay card Transaction details</a>
									                 </td>
									             ...
									             <tr>
									                 ...
									                 <td align="center"> 
									                       <a href="<%=request.getContextPath()%>/bceljcbtransactiondetails/${fn:replace(repordateVal,'/','')}">BCEL JCB card Transaction details</a>
									                 </td>
									             ...
									             <tr>
									                 ...
									                 <td align="center"> 
									                        <a href="<%=request.getContextPath()%>/offusunionpaytxndetails/${fn:replace(repordateVal,'/','')}">Offus unionpay card Transaction details</a>
									                 </td>
