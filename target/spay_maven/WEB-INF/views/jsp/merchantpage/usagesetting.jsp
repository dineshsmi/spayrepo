					...
					<div class="col-md-12">
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <a href="<%=request.getContextPath()%>/createinvoice"><button class="btn grayclr" type="button" id="reg" style="border-radius: 25px !important;width:120px;">Create Invoice</button></a>
                              ...
                              <a href=""><button class="btn redclr" type="button" id="modify" style="border-radius: 25px !important;width:120px;">Setting</button></a>
								...
								<form name="usagesettingform" class="form-horizontal" role="form" action="" method="post">
									<div class="form-body" id="Container" style="text-align: left;padding-left:160px;">
										<div class="form-group">
										      <label class="col-md-2 control-label" for="merchant_merchantId">Merchant mail ID:</label>
											
											  <div class="col-md-10" id="test">
												  <input type="text" class="form-control" id="merchantmailid"  placeholder="" name="MerchantmailId" style="width:400px;">
												  <div id="errorstatus"> 
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="merchantname" placeholder="" name="Merchantname" style="width:400px;">
											</div>
										</div>
										
										<div class="form-group">
											<label class="col-md-2 control-label">Merchant Address:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" id="merchantaddress" placeholder="" name="Merchantaddress" style="width:400px;">
											</div>
										</div>
										
										
										<div class="form-group">
											<label class="col-md-2 control-label">Merchant Tel:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" id="merchanttel" placeholder="" name="Merchanttel" style="width:400px;">
											</div>
										</div>
										<div class="form-group">
										...
										<button type="submit" class="btn redclr" id="btn1" align="center" style="border-radius: 25px !important;width:80px;">Save</button>
										<button type="submit" class="btn grayclr" id="btn2" style="border-radius: 25px !important;width:80px;">Reset</button>
									   </div>
