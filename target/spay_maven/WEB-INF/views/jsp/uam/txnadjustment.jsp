					...
					<div class="col-md-12">
						...
						<div>	
                           ...
                           <%--  <a href="<%=request.getContextPath()%>/realtimetxn" ><button class="btn blue" type="button">Realtime Transaction Monitoring</button></a> --%>
                            ...
                            <a href="<%=request.getContextPath()%>/txnstmt"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:188px;">Transaction Statement</button></a>
                            
                             <a href="<%=request.getContextPath()%>/txnadjustment"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:188px;">Transaction Adjustment</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" action="searchtranactionadjustment" method="post">
									<div class="form-body" style="text-align: left;padding-left:160px;">
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="tdate" readonly="readonly" placeholder="" name="tdate" style="width:400px;">
											</div>
										</div>
