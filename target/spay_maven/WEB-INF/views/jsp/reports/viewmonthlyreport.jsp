...
function backFun(){
	document.searchform.action="<%=request.getContextPath()%>/backtomonthlyreport";
	document.searchform.submit();
}

<%-- function viewTransactionSatatement(val){
	//alert("viewTransactionSatatement==>"+val);
	var tid = val.value;
	window.open("<%=request.getContextPath()%>/transactionstatementpopup?tid="+tid,"_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=200, left=500, width=1000, height=1000")
} --%>
						...
						<div class="portlet box red">
							...
							<div class="portlet-body flip-scroll">
								<div id="id_exportoptions"> 
                                    ...
                                    <a href= "generateReport/PDF/monthlyreport/${merchantDOB}"> PDF</a>
                                    <a href= "generateReport/XLS/monthlyreport/${merchantDOB}"> XLS</a>
                                    <a href= "generateReport/CSV/monthlyreport/${merchantDOB}"> CSV</a>
