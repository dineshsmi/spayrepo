...
function backFun(){
	document.searchform.action="<%=request.getContextPath()%>/backtodailyreport";
						...
						<div class="portlet box red">
							...
							<div class="portlet-body flip-scroll">
								<div id="id_exportoptions"> 
                                    ...
                                    <a href= "generateReport/PDF/dailyreport"> PDF</a>
                                    <a href= "generateReport/XLS/dailyreport"> XLS</a>
                                    <a href= "generateReport/CSV/dailyreport"> CSV</a>
