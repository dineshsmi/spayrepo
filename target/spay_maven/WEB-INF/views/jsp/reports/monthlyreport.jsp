				...
				<div class="row">
					<div class="col-md-12">
                        ...
                        <!--------detail start------------>
                         ...
                         <div>
                         <a href="<%=request.getContextPath()%>/showdailyreports"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:120px;">Daily Report</button></a>
                         <a href="<%=request.getContextPath()%>/showmonthlyreports"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:125px;">Monthly Report</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form name="monthlyreportform" class="form-horizontal" role="form" action="getMonthlyReport" method="post" id="merchant">
							   ...
							   <div id="reportmainpage">
									<div class="form-body" id="Container">
										...
										<!-- <div class="form-group">
											<label class="col-md-2 control-label">Report Month:</label>
											<div class="col-md-10">
										...
										<div class="form-actions" style="text-align: left;padding-left:180px;">
										  ...
										  <button type="submit" class="btn redclr" id="sbt_btn" align="center" onclick="return validate()" style="border-radius: 25px !important;width:100px;">Submit</button>
										
										  <!-- <button type="button" class="btn grayclr" id="regenerate_btn" align="center" style="border-radius: 25px !important;width:100px;">Regenerate</button> -->
