		...
		$("#btn1").click(function(event){	
			...
			if(seleDatVal == finalCurrdate){
				...
				alert("Please select date lesser than todays date");
				 ...
				 document.representmentform.transactiondate.value="";
				 document.representmentform.transactiondate.focus();
				 return false;
			}else{
				
				document.representmentform.submit();
			}
					...
					<div class="col-md-12">
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <a href="<%=request.getContextPath()%>/chargeback"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:160px;">Chargeback Request</button></a>
                             
                              <a href="<%=request.getContextPath()%>/chargebackview"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:160px;">Chargeback View</button></a>
                              
                             <a href="<%=request.getContextPath()%>/representmentform"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:160px;">Representment View</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form name="representmentform" action="representmentview" class="form-horizontal" role="form" method="post">
									<div class="form-body" id="Container" style="text-align: left;padding-left:160px;">
										...
										<div class="form-group">
											  ...
											  <div class="col-md-10" id="test">
												  <input type="text" class="form-control" id="merchnatID" placeholder="" name="merchantID" maxlength ="10" style="width:400px;">
												   <span class="error_show" id="errorspan" align="center"></span>
											 </div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="transactiondate" placeholder="" name="txndate" maxlength ="10" style="width:400px;">
											</div>
										</div>
									    ...
									    <div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="cardnum" name="cardnum" style="width:400px;">
											</div>
										</div>
                                        
                                        <div class="form-group">
											<label class="col-md-2 control-label">Transaction Reference No:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="txnref" name="txnref" maxlength="14" style="width:400px;">
											</div>
										</div>
										
										
										 <div class="form-group">
											<label class="col-md-2 control-label">Trace No:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="traceno" name="traceno" maxlength="14" style="width:400px;">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="respcode" name="respcode" maxlength="14" style="width:400px;">
											</div>
										</div>
										
										
										<div class="form-group">
											<label class="col-md-2 control-label">Txn Currency:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="txncurrency" name="txncurrency" maxlength="14" style="width:400px;">
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-md-2 control-label">Txn Amount:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="txnamount" name="txnamount" maxlength="14" style="width:400px;">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="txnacctstatus" name="txnacctstatus" maxlength="14" style="width:400px;">
											</div>
										</div>
										
										
										<div class="form-group">
											<label class="col-md-2 control-label">Txn Fee:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="txnfee" name="txnfee" maxlength="14" style="width:400px;">
											</div>
										</div>
										
										<div class="form-group">
											<label class="col-md-2 control-label">Settle Amnt:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="settleamount" name="settleamount" maxlength="14" style="width:400px;">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="settleccy" name="settleccy" maxlength="14" style="width:400px;">
											</div>
										</div>
										
										
										<div class="form-group">
											<label class="col-md-2 control-label">Reason for Chargeback Rejection:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="chargebackrejection" name="chargebackrejection" maxlength="14" style="width:400px;">
											</div>
										</div>
									</div>	
									  <div class="form-actions" style="text-align: left;padding-left:315px;">
										...
										<button type="button" class="btn grayclr" id="back_btn" align="center" style="border-radius: 25px !important;width:80px;">Cancel</button>
