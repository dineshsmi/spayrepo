...
<script>
 ...
 function viewRealTranaction(val){
		...
		window.open("<%=request.getContextPath()%>/chargebackresultpopup?tid="+val +"&strChbkView="+strChbkView,"_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=200, left=500, width=1000, height=1000")
	}
