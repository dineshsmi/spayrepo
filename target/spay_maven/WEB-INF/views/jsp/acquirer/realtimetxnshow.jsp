	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<h3 class="page-title">
				Payment Screen Setup Confirmed
				</h3>
				<div class="page-bar">
					...
					<div class="col-md-12">
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" name="selectform" action="realtimetxninsert">
									<div class="form-body">
									
										<div class="row">
											
											  <div class="col-xs-5">Realtime transaction monitoring inserted successfully</div>
									 ...
									 <div class="form-actions right1">
										...
										<button type="submit" class="btn grayclr" id="id_sbtbtn" style="border-radius: 25px !important;">Back</button>
									</div>
								</form>
							</div>
						</div>
