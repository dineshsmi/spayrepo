...
$('#done_btn').click(function(event){
		...
		//alert("In sbt btn click");
				
		document.frmOTPsuccessmsg.submit();
				...
				<div class="row">
					<div class="col-md-12">
                        ...
                        <div class="portlet box red">
						  ...
						  <form name="frmOTPsuccessmsg"  action="redirectToOTPmessageform">	
							<div id="container">
								
								<br/>
								
								<div align="left">
								      OTP template design wil be updated with the latest Changes on <c:out value="${effectivedate}"/>
								</div>	
								...
								<div align="left">
								               ...
								               <input type="button" class="btn redclr"  name="Submit" value="Done" id="done_btn" style="border-radius: 25px !important;width:80px;"> 
