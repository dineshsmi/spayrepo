...
$(document).ready(function(){
	...
	document.getElementById("id_errorempId").innerHTML = "";
	document.getElementById("id_errorusername").innerHTML = "";
	document.getElementById("id_emailid").innerHTML = "";
						...
						<!--------detail start------------>
                         <div class="portlet box red">
							...
							<div class="portlet-body form">
							   ...
							   <form name="frmModifyuserform" action="showUserModification" class="form-horizontal" role="form" method="post">
									<div class="form-body" style="text-align: left;padding-left:160px;">
										
										<div class="form-group">
											<label class="col-md-2 control-label">Employee ID:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" name="employeeId" onkeypress="removeerrempId();" id="employeeId" style="width:400px;">
												<span style="color: red;" id="id_errorempId">Employee Id is required</span>
											</div>
										</div>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" name="userName" onkeypress="removeerrusername();" id="userName" style="width:400px;">
												<span style="color: red;" id="id_errorusername">User Name is required</span>
											</div>
										</div>
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" name="EmailId" onkeypress="removeerremailId();" id="EmailId" style="width:400px;">
												<span style="color: red;" id="id_emailid">Email Id is required</span>
											</div>
										</div>
...
function validFun(){
	...
	if(email!=""){
	   ...
	   if (filter.test(email)) {
		...
		//alert("Invalid email");
		document.getElementById("id_emailid").innerHTML="Please Enter a Valid Email";
	    return false;
	   }
	...
	if(eid == "" && uname == "" && email == ""){
		...
		alert("Enter the employee id or user name or email");
		
		document.getElementById("id_errorempId").innerHTML = "Employee Id is required";
		document.getElementById("id_errorusername").innerHTML = "UserName is required";
		document.getElementById("id_emailid").innerHTML = "Email Id is required";
...
function removeerrempId(){
	document.getElementById("id_errorempId").innerHTML = "";
	
}


function removeerrusername(){
	document.getElementById("id_errorusername").innerHTML = "";
	
}


function removeerremailId(){
	document.getElementById("id_emailid").innerHTML = "";
