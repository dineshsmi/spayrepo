	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<h3 class="page-title">
				Branch / Department / Designation Conformation code
				</h3>
					...
					<div class="col-md-12">
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" name="selectform" action="desdepbranch">
									<div class="form-body">
									
										<div class="row">
											
											  <div class="col-xs-5">${successdata}</div>
