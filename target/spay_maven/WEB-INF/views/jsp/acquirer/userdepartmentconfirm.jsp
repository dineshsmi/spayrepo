...
<div class="container">
					...
					<div class="col-md-12">
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" name="productfrom" action="userdepartment">
									<div class="form-body" style="text-align: left;padding-left:160px;">
									
										<div class="row">
											
											  <div class="col-xs-5">Assign Rights inserted successfully</div>
									 ...
									 <div class="form-actions right1" style="text-align: left;padding-left:315px;">
										...
										<button type="submit" class="btn redclr" id="id_sbtbtn" style="border-radius: 25px !important;width:80px;">Back</button>
									</div>
								</form>
							</div>
						</div>
	...
	<div class="page-footer">
		<div class="page-footer-inner">
			<p style="margin-left:1070px"> @Powered by Sysmatik</p>
		</div>
