					...
					<div class="col-md-12">
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <a href="<%=request.getContextPath()%>/txnstmt"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:120px;">Transaction Statement</button></a>
                             
                             <a href="<%=request.getContextPath()%>/txnadjustment"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:120px;">Transaction Adjustment</button></a>
                             
                              <!-- <a href=""><button class="btn btnback" type="button">Chargeback View</button></a>
                              
                             <a href=""><button class="btn blue" type="button">Representment View</button></a>
                              -->
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form name="chargebackform" class="form-horizontal" role="form" method="post">
									<div class="form-body" id="Container" style="text-align: left;padding-left:160px;">
										<div class="form-group">
											  ...
											  <div class="col-md-10" id="test">
												  <select class="form-control" id="merchnatID" name="merchantID" style="width:400px;">
													<option value="0">-Select-</option>
                                                    <option value="MER6767889">MER6767889</option>
