...
<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div>	
                            ...
                            <!--  <a href=""><button class="btn blue" type="button">Financial Posting</button></a> -->
                            
                           
                           <%--  <a href="<%=request.getContextPath()%>/realtimetxn" ><button class="btn blue" type="button">Realtime Transaction Monitoring</button></a> --%>
                             
                            <a href="<%=request.getContextPath()%>/txnstmt"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:188px;">Transaction Statement</button></a>
                            
                             <a href="<%=request.getContextPath()%>/txnadjustment"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:188px;">Transaction Adjustment</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" action="showTxnstatementresult" method="post" id="formvalidate">
									<div class="form-body" style="text-align: left;padding-left:160px;">
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="tdate" readonly="readonly" placeholder="" name="merchantDOB" style="width:400px;">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="cardnumber" placeholder="" name="merchantCardNo" style="width:400px;">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">Transaction Ref no:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" id="trefno" placeholder="" name="txnrefno" style="width:400px;">
											</div>
										</div>
	...
	<div class="page-footer">
		<div class="page-footer-inner">
			<p style="margin-left:1085px"> @Powered by Sysmatik</p>
		</div>
...
//$( "#tdate" ).datepicker();
$("#tdate" ).datepicker({changeMonth: true,changeYear:true,yearRange: "1900:3000"});
});
...
function validFun(){
	...
	if(tdate != ""){
		...
		var currinput = new Date(tdate);
        var currdate = new Date(); // today date
        currdate.setMonth(currdate.getMonth() - 6);  //subtract 6 month from current date 

        if (currinput > currdate) {
          //  alert("date is less than 6 month");
        } else {
            alert("Transaction Date will allow only past 6 month");
            return false;
        }
	}
