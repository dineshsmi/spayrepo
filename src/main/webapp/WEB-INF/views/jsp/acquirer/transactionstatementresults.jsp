...
<script>
 ...
 function viewRealTranaction(val){
	    ...
	    //alert("===val====>"+val);
	    var strChbkView = document.getElementById("id_strChbkView").value;
	    
	    //alert("===strChbkView====>"+strChbkView);
	  
		window.open("<%=request.getContextPath()%>/transactionstatementpopup?tid="+val,"_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=200, left=500, width=1000, height=1000")
	}
					...
					<div class="col-md-12">
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body flip-scroll">
							 ...
							 <input type="hidden" id="id_strChbkView" name="strChbkView" value="${screenname}">
								...
								<tr>
								 ...
								 <div class="form-actions right1">
									<button type="button" class="btn grayclr" style="border-radius: 25px !important;width:80px;" onclick="backFun()">Back</button>
