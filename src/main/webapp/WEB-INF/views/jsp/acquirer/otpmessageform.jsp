...
$(function() {
    $("#OTP_effectivedate" ).datepicker({changeMonth: true,changeYear:true,yearRange: "1900:3000"});
...
$(document).ready(function(){
	 ...
	 $('#OTP_otpmessage').on('input', function() {
		    var input=$(this);
	 ...
	 $('#OTP_effectivedate').change('input', function() {
	    var input=$(this);
		var is_name=input.val();
		if(is_name){input.removeClass("invalid").addClass("valid");}
		else{input.removeClass("valid").addClass("invalid");}
...
$('#submit_btn').click(function(event){
	...
	var form_data=$("#id_otpmsg_form").serializeArray();
	...
	for (var input in form_data){
	    ...
	    if($('#OTP_otpmessage').val()!="" && $('#OTP_effectivedate').val()!=""){
	    	
	    	//alert(status);
	    	 if(status){
	 	    	document.frmOTPmessage.submit();
	 	    }
	    }
	

		
		//alert("In sbt btn click"+status);
...
function myFunction() {
    ...
    window.location.href="<%=request.getContextPath()%>/expiryform";
...
<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div>	
                             ...
                             <a href=""><button class="btn redclr" type="button" style="border-radius: 25px !important;width:120px;">OTP Setup</button></a>
                             
                             <a onclick="myFunction();"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:120px;padding-left:1px;">OTP Expiry Period</button></a>
 ...
 -->						</div> 
                        ...
                        <div class="portlet box red">
						  ...
						  <form name="frmOTPmessage"  action="saveOTPmessage" method="POST" id="id_otpmsg_form">	
							<div id="container">
								<div id="left">
								        <span id="textdisplay">OTP<br />Message<br />Template</span>
								</div>	
								
								<div align="left">
								
								  
								    <textarea style="width:700px;height:135px;text-align:left;" name="otpmessage" id="OTP_otpmessage">
								       
                                      
                                     </textarea>
                                     <span class="error"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OTP Message is required</span>
								...
								<div align="left">
								                ...
								                Effective date : <input type="text" name="effectivedate" id="OTP_effectivedate"> 
