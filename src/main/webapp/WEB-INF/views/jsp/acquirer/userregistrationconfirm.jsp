			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="#">User Registration Confirmation</a>
						</li>
					...
					<div class="col-md-12">
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" name="productfrom" action="userform">
									<div class="form-body">
									
										<div class="row">
											
											  <div class="col-xs-5">User inserted successfully</div>
