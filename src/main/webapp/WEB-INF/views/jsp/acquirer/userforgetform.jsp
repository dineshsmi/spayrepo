...
$(document).ready(function(){
	...
	$("#sbt_btn").click(function(event){
		...
		var empId = document.getElementById("id_employeeId").value;
		
		if(empId == ""){
			
			document.getElementById("error_display").innerHTML="Employe Id is required";
			return false;
		}else{
			
			document.getElementById("error_display").innerHTML="";
			document.frmUserforgetform.submit();
		}
		
		
		//document.frmModifyuserform.submit();
...
function getEmailId(){
	...
	$.ajax({
		...
		type: 'GET',
		url: '<%=request.getContextPath()%>/getEmailIdbyEmpId',
		data: {employeeId: $('#id_employeeId').val()},
		success: function(response) {
			 ...
			 if(response.length>0)
			 {
			   ...
			   if(response=="null"){
				   ...
				   document.getElementById("id_errordisplay").innerHTML = "Please Enter the Correct EmployeeId";
				   
			   }else{
			   
			   var parsedJson = $.parseJSON(response);
		       var name = parsedJson[0].emailid;
		       var password = parsedJson[0].password;
		       document.getElementById("id_EmailId").value = name;
		       document.getElementById("id_password").value = password;
		       $("#sbt_btn").show();
		       document.getElementById("id_errordisplay").innerHTML = "";
		       document.getElementById("id_instruction").innerHTML = "";
		      }
			 }else{
			    	/* content="<span class="+"error_show"+">Employee Id is incorrect</span>";
					...
					<div class="col-md-12">
						...
						<a href="<%=request.getContextPath()%>/desdepbranch"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:136px;padding-left:3px;">Branch Registration</button></a>
                             ...
                             <a href="<%=request.getContextPath()%>/modifyuser"><button class="btn grayclr" type="button" id="modify" style="border-radius: 25px !important;width:120px;">Modify User</button></a>
                              ...
                              <a href="<%=request.getContextPath()%>/userforget"><button class="btn redclr" type="button" id="delete" style="border-radius: 25px !important;width:120px;padding-left:5px;">Forget Password</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form name="frmUserforgetform" class="form-horizontal" role="form" method="post" action="sendForgotPwdLink">
									<div class="form-body" style="text-align: left;padding-left:160px;">
										
										<span id="errorstatus"></span>
										
										<input type="hidden" class="form-control" placeholder="" id="id_password" name="password" style="width:400px;">
										
										<input type="hidden" class="form-control"  value= "${mailSent}">
										
										 <c:if test="${mailSent == 'mailSent'}">
					                           <span i style="color:green;margin-left:160px;">Email Sent to your Mail Id</span>
					
					                     </c:if>
										
										<div class="form-group">
										    <span id="id_instruction" style="color:green;padding-left:160px;">Please enter your EmployeeId to retain the Password</span>
										    <br />
										    <span id="id_errordisplay" style="color:red;padding-left:20px;"></span>
										    
											<label class="col-md-2 control-label" style="padding-top:25px;">Employee ID:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" name="employeeId" id="id_employeeId" style="width:400px;" onblur="getEmailId();">
                                       ...
                                       <!--<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" name="userName" style="width:400px;">
											</div>
										</div> -->
											...
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="" id="id_EmailId" name="EmailId" style="width:400px;" disabled>
											</div>
										</div>
									...
									<div class="form-actions" style="text-align: left;padding-left:315px;" >
										...
										<button type="submit" class="btn redclr" id="sbt_btn" style="border-radius: 25px !important;width:80px;">Submit</button>
										<button type="button" class="btn grayclr" id="id_cancel" style="border-radius: 25px !important;width:80px;">Cancel</button>
