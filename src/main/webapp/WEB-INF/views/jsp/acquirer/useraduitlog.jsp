...
$(function() {
    $("#fromdate").datepicker({changeMonth: true,changeYear:true,yearRange: "1900:3000"});
    
    $("#todate").datepicker({changeMonth: true,changeYear:true,yearRange: "1900:3000"});
					...
					<div class="col-md-12">
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <a href="<%=request.getContextPath()%>/desdepbranch"><button class="btn blue" type="button" style="border-radius: 25px !important;width:136px;padding-left:3px;">Branch Registration</button></a>
                             ...
                             <a href="<%=request.getContextPath()%>/useraudit"><button class="btn purple-soft" type="button">Audit Trail</button></a>
                        ...
                        <div class="portlet box blue-chambray">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" method="post" name="useraduit">
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="fromdate" placeholder="" name="fromdate" maxlength ="10">
											</div>
										</div>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="todate" placeholder="" name="todate" maxlength ="10">
											</div>
										</div>
