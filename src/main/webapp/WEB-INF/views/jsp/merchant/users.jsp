...
<div class="page-header navbar navbar-fixed-top"> 
  ...
  <div class="page-header-inner container"> 
    <!-- BEGIN LOGO -->
    <div class="page-logo"> <a href="index.html"> <img src="../assets/admin/layout2/img/logo02.png" alt="logo" class="logo-default"/> </a>
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-title">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-gift font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Record Listing</span> <span class="caption-helper">manage records...</span> </div>
                  </div>
                </h4>
              </div>
                      ...
                      <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                        <thead>
                          <tr role="row" class="heading">
                            <th width="2%"> <input type="checkbox" class="group-checkable">
                            </th>
                          ...
                          <tr role="row" class="filter">
                            ...
                            <td><input type="text" class="form-control form-filter input-sm" name="order_customer_name"></td>
            ...
            <div class="portlet box red">
              ...
              <div class="portlet-body flip-scroll">
                ...
                <div class="form-actions">
                    <button type="button" class="btn green">New User</button>
                    <button type="submit" class="btn red">Delete Selected User</button>
                </div>
              </div>
                                            ...
                                            <div class="col-md-10">			
                                                <div class="input-group">
                                                    <div class="icheck-inline">
                                                        <label><input type="checkbox" class="icheck">&nbsp; Payment Page</label>
                                                        <label><input type="checkbox" class="icheck">&nbsp; Batch Payment</label>
                                                        <label><input type="checkbox" class="icheck">&nbsp; Manual Payment</label>
                                                        <label><input type="checkbox" class="icheck">&nbsp; Report</label>
                                                        <label><input type="checkbox" class="icheck">&nbsp; Users</label>
                                                    </div>
                                                </div>			
                                            </div>
