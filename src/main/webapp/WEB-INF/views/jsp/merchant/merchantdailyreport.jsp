                      ...
                      <div>
                        ...
                        <div class="portlet box blue-chambray">
							...
							<div class="portlet-body form">
								<form name="dailyreportform" class="form-horizontal" role="form" action="getDailyReportMearchent" method="post" id="merchant">
							   ...
							   <div id="reportmainpage">
									<div class="form-body" id="Container">
										...
										<div class="form-actions" align="center" style="text-align: left;padding-left:180px;">
										 ...
										 <input type="submit" class="btn redclr" id="id_sbtbtn" value="Submit" style="border-radius: 25px !important;width:80px;">
