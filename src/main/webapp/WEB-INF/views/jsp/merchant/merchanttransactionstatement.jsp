					...
					<div class="col-md-12">
						...
						<div class="portlet box blue-chambray">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" action="addmerchant" method="post" id="formvalidate">
									...
									<div class="form-body" id="Container">
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="merchantDOB" placeholder="" name="merchantDOB">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control"  id="cardnumber" placeholder="" name="cardnumber" list="hosting-plan">
												</div>
										</div>
                                        
                                        <div class="form-group">
											<label class="col-md-2 control-label">Transaction Ref.Number:</label>
											<div class="col-md-10">
												<input type="text" class="form-control" id="transactionrn" placeholder="" name="transactionrn">
											</div>
										</div>
										<div class="form-actions right1" style="text-align: left;padding-left:180px;">
										<button type="submit" class="btn green" id="btn1" align="center">Submit</button>
										<button type="button" class="btn default" id="btn2" align="center">Reset</button>
