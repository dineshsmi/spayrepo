...
<script>
 ...
 $(function() {
	 ...
	 //merchant_merchantDOB
      ...
      $("#merchant_merchantDOB" ).datepicker({maxDate: new Date});	
...
$(document).ready(function(){
	...
	$("#id_tablerecords").hide();
	
	$("#id_exportoptions").hide();
	 
	 <!-- After Form Submitted Validation-->
	$("#sbt_btn").click(function(event){	 	
			
		var seleDatVal = $("#merchant_merchantDOB").val();
		...
		if(seleDatVal == finalCurrdate){
			...
			alert("Please select date lesser than todays date");
			 ...
			 document.dailyreportform.merchant_merchantDOB.value="";
			 document.dailyreportform.merchant_merchantDOB.focus();
			 return false;
		}else{
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
                      ...
                      <div>
                        <a href="<%=request.getContextPath()%>/showdailyreports"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:120px;">Daily Report</button></a>
                         <a href="<%=request.getContextPath()%>/showmonthlyreports"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:125px;">Monthly Report</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form name="dailyreportform" class="form-horizontal" role="form" action="getDailyReport" method="post" id="merchant">
							   ...
							   <div id="reportmainpage">
									<div class="form-body" id="Container">
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="" id="merchant_merchantDOB" placeholder="" name="merchantDOB">
										...
										<div class="form-actions" align="center" style="text-align: left;padding-left:180px;">
										
										  <button type="submit" class="btn redclr" id="sbt_btn" align="center" style="border-radius: 25px !important;width:100px;">Submit</button>
