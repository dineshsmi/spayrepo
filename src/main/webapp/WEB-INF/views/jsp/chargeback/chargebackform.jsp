					...
					<div class="col-md-12">
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <!-- <a href=""><button class="btn blue" type="button">Register</button></a> -->
                                ...
                                <a href="<%=request.getContextPath()%>/chargeback"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:160px;">Chargeback Request</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form name="chargebackform" action="chargeback" class="form-horizontal" role="form" method="post">
									 ...
									 <span class="error" id="errorspan"></span>
										<div class="form-group">
											  ...
											  <div class="col-md-10" id="test">
												  ...
												  <!-- <select class="form-control" id="merchnatID" name="merchantID">
													<option value="0">-Select-</option>
                                                    <option value="1234566">1234566</option>
                                                    <option value="MER45656767">MER45656767</option>
                                                    <option value="MER788989">MER788989</option>
                                                    </select>
