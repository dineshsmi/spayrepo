...
<script>
 ...
 $(document).ready(function(){
	 ...
	 $("#id_Chargebackviewdiv").hide();
	 
	 
	     var Listresult = document.getElementById("id_Listresultval").value;
		
		//alert("Listresult==>"+Listresult);
		
		 if(Listresult==""){
			//alert("Listresult empty");
		}else{
			
			//alert("In else and Listresult not empty");
			$("#id_MerchantIddiv").hide();
			 $("#id_Chargebackviewdiv").show();
		...
		$("#btn1").click(function(event){	
			...
			//alert(merchantid);
				if(merchantid == ""){
		           ...
		           document.frmChargebackView.submit();
				}   
			});
 ...
 function viewRealTranaction(val){
	    ...
	    //alert("In chargebackViewpopup"+val);
	    
	    var chargebackview =  document.getElementById("id_chargebackview").value;
	    
	    //alert("chargebackview==>"+chargebackview);
	    
	    window.open("<%=request.getContextPath()%>/chargebackViewpopup?tid="+val,"_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=200, left=500, width=1000, height=1000")
				...
				<div class="row">
					<div class="col-md-12">
						<div>	
                            ...
                            <a href="<%=request.getContextPath()%>/chargebackview"><button class="btn redclr" type="button" style="border-radius: 25px !important;width:160px;">Chargeback View</button></a>
                              
                            <a href="<%=request.getContextPath()%>/representmentform"><button class="btn grayclr" type="button" style="border-radius: 25px !important;width:160px;">Representment View</button></a>
                      </div>
                        ...
                        <div class="portlet box red">
							<div class="portlet-title">
							  ...
							  <div id="id_MerchantIddiv" class="form-group">
							     <form name="frmChargebackView" action="getChargebackrasiedbyMerId" method="GET">
										      <label class="col-md-2 control-label" for="merchant_merchantId">Merchant ID:*</label>
											        <input type="text" id="merchnatID" name="merchantID">
					        ...
					        <input type="hidden" id="id_Listresultval" name="chargebackviewresult" value="${txnmonitoringList}">
					        
					        <input type="hidden" name="chargebackview" value="chargebackview" id="id_chargebackview">
							
							<div id="id_Chargebackviewdiv" class="portlet-body flip-scroll">
