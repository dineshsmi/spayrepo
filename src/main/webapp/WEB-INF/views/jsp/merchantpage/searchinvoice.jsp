					...
					<div class="col-md-12">
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <!-- <a href=""><button class="btn blue" type="button">Register</button></a> -->
                              ...
                              <a href=""><button class="btn redclr" type="button" id="modify" style="border-radius: 25px !important;width:120px;">View Invoice</button></a>
                        ...
                        <div class="portlet box red">
							...
							<div class="portlet-body form">
								<form name="searchinvoice" class="form-horizontal" role="form" action="" method="post">
									<div class="form-body" id="Container" style="text-align: left;padding-left:160px;">
										<div class="form-group">
										      <label class="col-md-2 control-label" for="merchant_merchantId">Order ID:</label>
											
											  <div class="col-md-10" id="test">
												  <input type="text" class="form-control" id="Orderid"  placeholder="" name="orderId" style="width:400px;">
												  <div id="errorstatus"> 
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="startdate" placeholder="" name="Startdate" style="width:400px;">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="enddate" placeholder="" name="Enddate" style="width:400px;">
											</div>
										</div>
										...
										<button type="submit" class="btn redclr" id="btn1" align="center" style="border-radius: 25px !important;width:80px;">Search</button>
