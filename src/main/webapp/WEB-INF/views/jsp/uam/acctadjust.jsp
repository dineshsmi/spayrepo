					...
					<div class="col-md-12">
						<div>	
                            <!--  <p> <a href="#portlet-config" data-toggle="modal"><button class="btn green" type="button">Add Merchant</button></p></a> -->
                             ...
                             <a href=""><button class="btn redclr" type="button" style="border-radius: 25px !important;width:167px;">Account Adjustment</button></a>
                             
                             <%--  <a href="<%=request.getContextPath()%>/searchmerchant"><button class="btn btnback" type="button" id="modify">Modify</button></a> --%>
                        ...
                        <!--------detail start------------>
                       <form name="acctadjustform" class="form-horizontal" role="form" action="insertaccountajustment" method="get">
                        <div class="portlet box red">
							...
							<div id="valdiv" class="portlet-body form" style="display: block;">
								
									<div class="form-body" id="Container" >
										<div class="form-group">
										      <label class="col-md-4 control-label" for="merchant_merchantId">Debit Account:</label>
											
											  <div class="col-md-6" id="test">
												  <select class="form-control" id="debitacct" name="debitacct" onchange="loadCredit()" style="width:400px;">
													<option value="0">-Select-</option>
                                                    <c:forEach var="merlist" items="${merlist}">
														<option value="${merlist.merchantName}">${merlist.merchantName}</option>
													</c:forEach>
													<option value="BCEL">BCEL</option>
                                                 </select> 
                                                 <div id="debvaldiv" style="color: red;margin-left:184px"></div>
												  </div>
                                        ...
                                        <div class="form-group">
											<label class="col-md-4 control-label">Credit Account:</label>
											<div class="col-md-6">
												<div id="creditdivone" style="display: block;"> 
												<select class="form-control" id="creditacct" name="creditacct" style="width:400px;">
													<option value="0">-Select-</option>
                                                    <option value="BCEL">BCEL</option>
                                                 </select> 
                                                 
												</div>
												<div id="creditdivtwo" style="display: none;">
												<select class="form-control" id="creditacct1" name="creditacct" style="width:400px;">
													<option value="0">-Select-</option>
                                                    <c:forEach var="merlist" items="${merlist}">
														<option value="${merlist.merchantName}">${merlist.merchantName}</option>
													</c:forEach>
												...
												<div id="crevaldiv" style="color: red;margin-left:184px"></div>
											</div>
										</div>
										
										<div class="form-group">
											<label class="col-md-4 control-label">Adujustment Account:</label>
											<div class="col-md-6">
												<input type="text" class="form-control" id="adjustacct" placeholder="" name="adjustacct" onkeypress="javascript:return isNumberCus (event)" style="width:400px;">
												<div id="aduvaldiv" style="color: red;margin-left:184px"></div>
											</div>
											...
											<div class="col-md-6">
												<select class="form-control" name="tcurrency" id="tcurrency" style="width:400px;">
                                                    ...
                                                    <c:forEach var="cclist" items="${cclist}">
														<option value="${cclist.currencycode}">${cclist.currencyname}</option>
													</c:forEach>
                                                 </select>
												<div id="currvaldiv" style="color: red;margin-left:184px"></div>
											</div>
											
										</div>
                                        
                                        <div class="form-group">
											<label class="col-md-4 control-label">Reason For Adjustment:</label>
											<div class="col-md-6">
												<input type="text" class="form-control" id="reason" placeholder="" name="reason" maxlength="20" style="width:400px;">
												<div id="adjvaldiv" style="color: red;margin-left:184px"></div>
											</div>
											
										</div>
										
										<div class="form-actions" style="text-align: left;padding-left:350px;">
											<button type="button" class="btn redclr" id="btn1" align="center" onclick="viewConfirm()" style="border-radius: 25px !important;width:80px;">Submit</button>
				                        	<button type="reset" class="btn grayclr" id="btn2" align="center" onclick="resetFun()" style="border-radius: 25px !important;width:80px;">Reset</button>
										</div>
                                    
								
								</div>
								<div id="condiv" class="portlet-body form" style="display: none;">
									...
									<div class="form-body" id="Container" style="text-align: left;padding-left:160px;">
										<div class="form-group">
											  ...
											  <div class="col-md-6" id="test">
                                                 ...
                                                 <div id="debitdiv" style="margin-top: 6px"></div>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-6">
												<div id="creditdiv" style="margin-top: 6px"></div>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<div id="adudiv" style="margin-top: 6px"></div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<div id="currencydiv" style="margin-top: 6px"></div>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-6">
												<div id="reasondiv" style="margin-top: 6px"></div> 
										...
										<div class="form-actions" style="text-align: left;padding-left:350px;">
											<button type="submit" class="btn redclr" id="btn1" align="center" style="border-radius: 25px !important;width:80px;">Confirm</button>
				                        	<button type="button" class="btn grayclr" id="btn2" align="center" onclick="backFun()" style="border-radius: 25px !important;width:80px;">Back</button>
				                        	<input type="hidden" id="hiddenreason" name="hiddenreason">
											<input type="hidden"  id="hiddentcurrency" name="hiddentcurrency" >
											<input type="hidden" id="hiddenadjustacct" name="hiddenadjustacct">
											<input type="hidden" id="hiddencreditacct" name="hiddencreditacct">
											<input type="hidden" id="hiddendebitacct" name="hiddendebitacct">
										</div>
...
function loadCredit(){
	if(document.getElementById("debitacct").value == "BCEL"){
		document.getElementById("creditdivone").style.display ='none'
		document.getElementById("creditdivtwo").style.display ='block'
	}else{
		document.getElementById("creditdivtwo").style.display ='none'
		document.getElementById("creditdivone").style.display ='block'
	}
}
function resetFun(){
	document.getElementById("debitacct").value = "0";
	document.getElementById("creditacct").value = "0";
	document.getElementById("adjustacct").value = "";
...
function viewConfirm(){
	...
	if(document.getElementById("debitacct").value == "0"){
		document.getElementById("debvaldiv").innerHTML="Select the debit account"
		document.getElementById("debitacct").focus();
		return false;
	}else{
		document.getElementById("debvaldiv").innerHTML=""
	}
	
		
		
	if(document.getElementById("creditacct").value == "0"){
		if(document.getElementById("creditacct1").value == "0"){
		
			document.getElementById("crevaldiv").innerHTML="Select the credit account"
			document.getElementById("creditacct").focus();
			return false;
		}else{
			document.getElementById("crevaldiv").innerHTML=""
		}
	}else{
	...
	if(document.getElementById("adjustacct").value == ""){
		document.getElementById("aduvaldiv").innerHTML="Adujustment account not empty"
		document.getElementById("adjustacct").focus();
		return false;
	}else{
		document.getElementById("aduvaldiv").innerHTML=""
	}
	
	if(document.getElementById("tcurrency").value == "0"){
		document.getElementById("currvaldiv").innerHTML="Select the currency"
		document.getElementById("tcurrency").focus();
		return false;
	}else{
		document.getElementById("currvaldiv").innerHTML=""
	}
	
	if(document.getElementById("reason").value == ""){
		document.getElementById("adjvaldiv").innerHTML="Reason for adjustment not empty"
		document.getElementById("reason").focus();
		return false;
	}else{
		document.getElementById("adjvaldiv").innerHTML=""
	}
	...
	var debit = document.getElementById("debitacct").value
	
	
	var credit = "";
	if(document.getElementById("creditacct").value != "0"){
		credit = document.getElementById("creditacct").value
	}
	if(document.getElementById("creditacct1").value != "0"){
		credit = document.getElementById("creditacct1").value
	}
	
	var adjust = document.getElementById("adjustacct").value
	var curr = document.getElementById("tcurrency").value
	var reson = document.getElementById("reason").value
	
	document.getElementById("debitdiv").innerHTML = debit;
	document.getElementById("hiddendebitacct").value = debit;
	
	document.getElementById("creditdiv").innerHTML = credit;
	document.getElementById("hiddencreditacct").value = credit;
	
	document.getElementById("adudiv").innerHTML = adjust;
	document.getElementById("hiddenadjustacct").value = adjust;
	
	document.getElementById("currencydiv").innerHTML = curr;
	document.getElementById("hiddentcurrency").value = curr;
	
	document.getElementById("reasondiv").innerHTML = reson;
	document.getElementById("hiddenreason").value = reson;
}

function isNumberCus(evt) {
    var iKeyCode = (evt.which) ? evt.which : evt.keyCode
   if (iKeyCode != 48 && iKeyCode > 31 && (iKeyCode < 48 || iKeyCode > 57)){
   	
   	 document.getElementById("aduvaldiv").innerHTML = "Number only allowed";
       return false;
   }
   document.getElementById("aduvaldiv").innerHTML =""; 
   return true;
